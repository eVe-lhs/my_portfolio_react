...
const Card = ({ picture, header, description, border, background }) => {
  ...
  const borderClass = `relative rounded-lg md:w-52 w-full h-52 shadow-xl border-b-2 ${border} z-50`;
  ...
  return (
    ...
    >
      <div
        className={` absolute rounded-lg h-full  mt-52 md:w-52 mb-0 z-20 flex flex-col justify-center items-center -translate-y-full transform origin-bottom transition-all duration-200  text-center ${background} bg-opacity-90 ${
      ...
      <div className="p-3 flex flex-col">
        <img
          className="w-36 h-full mx-auto my-4"
          src={picture}
          alt={description}
        />
      </div>
...
const Personal = ({ profileData }) => {
  return (
    <>
      <div className="pt-40">
        <div className="mx-2  p-3 text-gray-700 dark:text-gray-200">
        ...
        <div className="md:flex mt-20 font-body font-light">
          <div className="px-6 ">
            <p className="leading-8">
              <span className="font-semibold">Hi I am Lin Htet Swe. </span>I am
              a Computer Science Student from Myanmar. I love doing both
              Front-end and Back-end Web Development. I like playing Video Games
              and a huge fan of Dota2. I also enjoy playing and watching
              football and a huge fan of Arsenal. These are some of my favourite
              things ...
            </p>
